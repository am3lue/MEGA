...
# !!! Main.UserApp is configured as an alias for Main.MEGA and you might encounter it in some tests
using Main.MEGA, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "MEGA tests" begin
  @includetests ARGS
end
